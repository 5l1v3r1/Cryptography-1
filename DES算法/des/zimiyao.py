'''
@Author: huha
@Date: 2019-10-26 12:49:59
@LastEditTime: 2019-10-26 15:38:32
@LastEditors: Please set LastEditors
@Description: 生成子密钥的模块
@FilePath: \DES实验\des\zimiyao.py
'''
MaxTime = 16
...
if __name__ == "__main__":
    ...
    keylist = list(keystr)
    subkeylist = Subkey(keylist)
    for x in range(len(subkeylist)):
        print("".join(subkeylist[x]))